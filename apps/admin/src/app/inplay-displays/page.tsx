...
export default function InPlayDisplaysPage() {
  ...
  async function deleteNote(id: string) {
    if (!confirm('Delete this display note?')) return;
    ...
    <RequireAdmin>
      <div className={styles.container}>
        <div className={styles.header}>
          <div>
            <h1 className={styles.title}>InPlay Displays</h1>
            <p className={styles.subtitle}>Track UI/UX improvements, display issues, and visual enhancements</p>
          </div>
          <button
            onClick={() => {
          ...
          >
            {showForm ? '✕ Cancel' : '+ Add Display Note'}
          </button>
        </div>
            ...
            <div className={styles.formGrid}>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  required
                  placeholder="Brief description of display change/issue"
                />
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Details about the display change, mockups, implementation notes..."
                />
              </div>
            </div>
        ...
        {loading ? (
          <div className={styles.loading}>Loading display notes...</div>
        ) : (
          <div className={styles.notesList}>
            {notes.length === 0 ? (
              <div className={styles.empty}>
                <p>No display notes yet. Click "Add Display Note" to track your first UI change.</p>
              </div>
            ) : (
              notes.map((note) => {
