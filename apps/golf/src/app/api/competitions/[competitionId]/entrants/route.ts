...
export async function GET(
  ...
  try {
    ...
    // Fetch competition details from unified table
    const { data: competition } = await supabase
      .from('tournament_competitions')
      .select('entrants_cap, entry_fee_pennies, admin_fee_percent, competition_format')
      .eq('id', competitionId)
      .maybeSingle();
    ...
    // Fetch all entries for this competition (unified schema)
